...
EMAIL_PORT = 587 #2525
EMAIL_HOST_USER = '36b5acf9ce8ddc'  # ваш username от Mailtrap
EMAIL_HOST_PASSWORD = 'b94482f5e07164'  # ваш пароль от Mailtrap
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
DEFAULT_FROM_EMAIL = 'anna.zakharova@mail.bk'  # укажите отправителя
