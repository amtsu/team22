...
def parse_data_from_page() -> list[dict[str, str]]:
    ...
    for service in services_with_html_tags:
        ...
        # добавляем сервис в словарь всех сервисов
...
def parse_data_from_personal_service_page(services_data: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    ADDRESS_CALSS = "text-indigo-500 inline-flex items-center ml-auto leading-none"
    ...
    for service in services_data:
        ...
        address = html_data_from_service_page.find("a", class_=ADDRESS_CALSS).text
