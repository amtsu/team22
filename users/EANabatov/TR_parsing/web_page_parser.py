...
class BookStoreParser:
    ...
    def parsing(self, start_parsing_index, end_parsing_index):
        ...
        for identificator in range(start_parsing_index, end_parsing_index + 1):
            ...
            try:
                ...
                if self.page.getcode() == 200:
                    if self.soup.find(href=re.compile("books"), class_="link-gray-light") and not self.soup.find(href=re.compile("magazines"), class_="link-gray-light"):
                        try:
                        ...
                        try:
                            __summary["the_year_of_publishing"] = ultimate_finder(__link, "Год издания:")
                        except:
                        ...
                        logging.info(f"Process {identificator}: OK (counter: {__counter})")
                        __counter += 1
                    else:
...
a2 = BookStoreParser()
print(a2.parsing(1156290, 1156292))
