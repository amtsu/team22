...
def import_data_from_excel_csv(*args, **kwargs):
    ...
    print("=" * 20)
    # sql_test = "INSERT INTO Employees(name, secname, surname, dep_id, salary) values('test','test','test',1,1)"
    # sql_test = "SELECT id from Departments WHERE name like 'Технический'"
    # result = kwargs["db"].execute(sql_test)
    # print(result)
