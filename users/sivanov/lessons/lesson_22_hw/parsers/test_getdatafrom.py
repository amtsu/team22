...
def test_webpage_str_1():
    ...
    """
    assert str(WebPage('test')) == 'url: test, opened: False, error codes: HTTP: 0, URL: 0, socket: 0'
#--------------------------------------------------------------------------------------------------
def test_webpage_str_2():
    """
    Тест создания экземпляра webpage и работоспособности его метода __str__
    """
    assert str(WebPage('test')) != 'url: test, opened: True, error codes: HTTP: 0, URL: 0, socket: 0'
#--------------------------------------------------------------------------------------------------
