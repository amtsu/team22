...
def test_cycle_element_of_set():
    ...
    assert cycle_element_of_set(set1) == expected   #если подать на вход кортеж, то функция не выведет уникальные элементы множества, 
...
#    """
#    assert cycle_number() == 1 4 9 16 25 
