...
class NashDomParserFFile(NashDomParser):
    """
    Собирает данные страницы, скачанной с сайта https://наш.дом.рф/сервисы/каталог-новостроек/список-объектов/список?page=0&limit=10 в файл 'sources/nash_dom' очищает их, сохряняет
    """
